...
sane = bleach.clean(html, all_tags, attrs, strip=True)

#os.unlink('testfile.html')
my_file = open('testfile.html', 'a')
my_file.write(sane.encode('utf-8'))
my_file.close()

#html5check.check('testfile.html')
